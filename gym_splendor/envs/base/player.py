...
# p
    def get_stocks(self, stocks, state, stock_return):
        ...
        print(Fore.LIGHTGREEN_EX, str(self.name), "LẤY NGUYÊN LIỆU", stocks, 'TRẢ', stock_return, end='')
        print(Style.RESET_ALL)            
    ...
    def check_get_card(self, Card):
        if Card == None:
            print(Fore.LIGHTRED_EX, str(self.name), "thẻ truyền vào bị rỗng".upper(), end='')
            print(Style.RESET_ALL)
            return False
    ...
    def get_upside_down(self, state, Card, stock_return):
        ...
        if a == None:
            ...
            print(Fore.LIGHTGREEN_EX, str(self.name),"úp Thẻ".upper(), Card.id, 'TRẢ', stock_return, end='')
            print(Style.RESET_ALL)
    ...
    def get_card(self, state, Card):
        ...
        print(Style.RESET_ALL)
        print(Fore.LIGHTGREEN_EX, str(self.name), "lật thẻ".upper(), end='')
        print(Style.RESET_ALL)
